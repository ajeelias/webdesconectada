...
$.widget( "ui.ntbrowse", {
        ...
        _bindEvents : function() {
			var _this = this;
			$(this.element).find('[data-elem="browse-table"]').off('scroll.tbl').on('scroll.tbl',function(e){_this.scrollTable(event);});
			//$(this.element).off('scroll.tbl','[data-elem="browse-table"]').on('scroll.tbl','[data-elem="browse-table"]',function(e){_this.scrollTable(event);});
			...
			if (this.options.rubberband){
				...
				$(this.element).off('mousedown.rbr','#' + this.options.id + '_rubberband').on('mousedown.rbr','#' + this.options.id + '_rubberband',function(e){_this.mouseDownCell(event);_this.mouseDownTable(event);});
